...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///puddles")
}
...
MIGRATION_MODULES = {"sites": "puddles.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "puddles.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "puddles.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "puddles.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
